...
const SellerPage = () => {
  return (
    <>
      <h1>This is Seller's page</h1>
      {/* <div className="flex flex-row gap-6 w-full  "> */}
        <div className="flex flex-col md:flex-row gap-6 w-full">
        {/* <div className="basis-1/3 bg-gray-50 h-72 flex flex-col items-stretch justify-between "> */}
        ...
        {/* <div className="basis-2/3 bg-gray-50 h-auto flex flex-row items-center  bg-[url('src/assets/images/seller_page_bg.jpg')] w-auto "> */}
