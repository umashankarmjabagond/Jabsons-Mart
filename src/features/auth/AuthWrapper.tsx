...
export const AuthWrapper: React.FC<AuthLayoutProps> = ({ children, title }) => {
  return (
    <>
      <div className="flex flex-col items-center justify-center md:relative min-h-screen w-full bg-green-900 md:bg-inherit">
        ...
        <div className="z-20 flex mt-2 w-full md:justify-end items-center px-3 lg:px-12  md:mt-0">
          <div className="w-full md:w-1/2 max-w-lg md:m-5 bg-white rounded-lg md:px-8 py-4 px-3  mb-3">
            {title && (
